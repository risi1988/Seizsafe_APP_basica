...
/**
 * Created by jonatan.Gonzalez on 04/12/2015.
 */
...
public class MjpegView extends SurfaceView implements SurfaceHolder.Callback {
                    ...
                    try {
                        ...
                        synchronized (mSurfaceHolder) {
                            try {
                                ...
                                Log.d("Reproductor", "excepcion al salir objeto c es null");
                                stopPlayback();
                            }
                        }
                    } finally {
    ...
    public void surfaceDestroyed() {
        ...
        System.out.println("Pauso el hilo" + thread.isInterrupted());
    }
